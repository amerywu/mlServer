...
import ikoda.ml.streaming.MLPCURLModelGenerationDataStream;
...
public class MLController
{
	...
	public MLController()
	{
		...
		MLPCURLModelGenerationDataStream.startStream();
	...
	public void tearDown()
	{
		...
		MLPCURLModelGenerationDataStream.stop();
	...
	public String startMLCPStream(HttpServletResponse response, HttpServletRequest request)
	{
		try
		{
			...
			MLPCURLModelGenerationDataStream.startStream();
			return MLPCURLModelGenerationDataStream.newDataSet(url, port,dataName,keySpaceName,keySpaceUUID);
		}
		catch (Exception e)
		{
			SSm.getLogger("ikoda.ml").error(e.getMessage(), e);
